...
class _OwnerDashboardPageState extends State<OwnerDashboardPage>
  ...
  // ✅ Auto-refresh saat owner kembali ke app (misal setelah user bayar)
  @override
  ...
  Future<void> _loadDashboard() async {
    ...
    final results = await Future.wait([
      ApiService.getOwnerBookings(),   // hanya pesanan pending
      ApiService.getOwnerDashboard(),  // statistik
    ]);
  ...
  Widget _buildRequestCard(BuildContext context, Map<String, dynamic> pesanan) {
    ...
    return GestureDetector(
      onTap: () async {
        ...
        // Reload setelah owner terima/tolak
