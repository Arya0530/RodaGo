...
import 'instruksi_pembayaran_page.dart'; // Pastikan file ini sudah ada di folder yang sama

class ProsesPembayaranPage extends StatefulWidget {
  final String namaMobil;
  final String totalHarga;

  ProsesPembayaranPage({required this.namaMobil, required this.totalHarga});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Pilih Pembayaran", style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(widget.totalHarga, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.teal)),
              ],
            ),
          ),
          SizedBox(height: 32),

          // KATEGORI 1: VIRTUAL ACCOUNT
          Text("Transfer Virtual Account", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black87)),
          SizedBox(height: 16),
          ...
          SizedBox(height: 100), // Ganjal bawah biar gak ketutup tombol
        ],
      ),

      // TOMBOL LANJUTKAN (Logika Navigasi Baru) 👇
      bottomSheet: Container(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () async {
              // PINDAH KE HALAMAN INSTRUKSI & TUNGGU JAWABAN (TRUE/FALSE)
              ...
              // Kalau di halaman instruksi klik "Konfirmasi", balikin TRUE ke pesanan_page
              if (lunas == true) {
            ...
            child: Text("Lanjutkan", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white)),
          ),
        ),
      ),
    );
